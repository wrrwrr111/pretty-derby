const Input = ({ className,register,name,placeholder})=>{
  ...
  <input
    className={`w-full h-full text-gray-800 leading-normal shadow-none outline-hidden focus:outline-hidden focus:ring-0 focus:text-gray-800 px-3 pt-2.5 pb-1.5 mt-input-outline-light-blue-500 mt-input-outline bg-transparent border border-1 border-gray-300 rounded-lg focus:border-2 focus:border-light-blue-500 undefined undefined`}
    placeholder=" "
    {...register("q")}
  />
  <label
